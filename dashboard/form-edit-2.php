...
include 'koneksi.php';
    $nomor = $_GET['nomor']; 
    $sql = "SELECT * FROM candidat_2 WHERE nomor='$nomor'";  
												...
												<form action="update.php" method="POST">
													<div class="paslon-1" style="display: flex; margin-top: 30px;" >
														...
														<div class="wakil" style="margin-left: 50px;">
															...
															<input type="text" name="nama_wakil" id="nama" style="height: 30px; border-radius: 10px; background-color: #2C254A; border: none; color: white; font-size: 17px; text-align: center;"  value="<?php echo $data['nama_wakil']?>">
														</div>
													...
													<div class="simpan">
														<input type="submit" name="simpan" id="simpan" value="simpan" style="margin-left: 200px; width: 100px; height: 34px; border-radius: 10px; border: none; background-color: #eb8153; color: white; margin-top: 20px;">
													</div>
												</form>
