        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Form Dashboard Pemilihan Ketua Osis</strong> © 2022 All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by Kelompok 4</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-3 col-sm-6 m-t35">
						<div class="card card-coin">
							<div class="card-body text-center">
								<h2 class="text-black mb-2 font-w600">Kandidat No. 1</h2>
								<p class="mb-0 fs-14">
					...
					<div class="col-xl-3 col-sm-6 m-t35" style="margin-left:100px;">
						<div class="card card-coin">
							<div class="card-body text-center">
								<h2 class="text-black mb-2 font-w600">Kandidat No. 2</h2>
								<p class="mb-0 fs-13">
					...
					<div class="col-xl-3 col-sm-6 m-t35" style="margin-left: 100px;">
						<div class="card card-coin">
							<div class="card-body text-center">
								<h2 class="text-black mb-2 font-w600">Total Vote</h2>
								<p class="mb-0 fs-14">
